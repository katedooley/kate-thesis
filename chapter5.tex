...
The WFS output matrix determines how to 
...
% D = 'drive' = DOF excitation to DOF excited matrix (theta_dof)
...
% actually exicted.
%
% To make D diagonal, we want to find a new M, M_new, which must have the
% property M_new = inv(U)*inv(C) = M*C*inv(D)*inv(C)
...
\begin{figure}
\begin{centering}
\subfigure{\includegraphics[width=1.0\columnwidth]{figures/WFSpittoDARM.pdf}}
\subfigure{\includegraphics[width=1.0\columnwidth]{figures/WFSyawtoDARM.pdf}}
