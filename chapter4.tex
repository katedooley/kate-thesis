...
An elegant implication of the purely geometric description of the
...
$P_{rp}/1+OP_{rp}$, leaving simply $P_{rp}$ for the WFS to
control. This turns out to not have deleterious effects, as shown in a
model by Barsotti.
