...
\begin{figure}
\begin{centering}
\subfigure{\includegraphics[width=1.0\textwidth]{figures/seis971128215_highWFSgain.pdf}}
\subfigure{\includegraphics[width=1.0\textwidth]{figures/seis956751915_nolock.pdf}}
\caption[]{Ground motion at time of high WFS gain measurement.}
\label{fig:}
\end{centering}
\end{figure}
